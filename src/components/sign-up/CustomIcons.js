...
export function NTechIcon() {
  return (
      <Icon sx={{ height: 40, width: 130 }}>
        <img
            src="https://static.wixstatic.com/media/54c3a8_37c6dc7d50a44e9b9eac56f352f07a04~mv2.png/v1/fill/w_439,h_143,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/ntechlogo.png"
            alt="Custom Icon"
